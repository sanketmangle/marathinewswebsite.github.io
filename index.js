            ...
            let news = `<div class="card">
                            <div class="card-header" id="heading${index}">
                                ...
                                <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapse${index}"
                                   ...
                                   <b>Breaking News ${index+1}:</b> ${element["title"]} - ${element.source.name}
                                </h2>
                            </div>
...
//https://gnews.io/api/v4/top-headlines?ltopic=health&lang=en&country=in&token=5b35849eaced6edb9927432501cf4499  **English News**